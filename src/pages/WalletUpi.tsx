      ...
      <main className="mx-auto max-w-md space-y-6 px-4 pt-8">
        ...
        <div className="space-y-2">
          ...
          <input
            ...
            className="w-full rounded-xl border border-primary/40 bg-[hsl(210,45%,8%)]/50 px-4 py-3 text-sm text-foreground placeholder:text-muted-foreground/50 backdrop-blur-sm focus:border-primary focus:outline-none focus:shadow-[0_0_12px_hsl(var(--primary)/0.2)] transition"
          />
        </div>
